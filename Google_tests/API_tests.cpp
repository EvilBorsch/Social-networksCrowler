...
TEST_F(TestAPI, testok) {
    ...
    EXPECT_EQ(ok->get_friends_urls_by_id("https://ok.ru/profile/551869915853"), vector<string>());
...
TEST_F(TestAPI, test_facebook) {
    vector<string> facebook_get_photo_ans = {
            "https://www.facebook.com/photo.php?fbid=113498916761448&set=a.113453566765983&type=3&theater",
    ...
    EXPECT_EQ(facebook->get_photo_urls_by_id("https://www.facebook.com/profile.php?id=100043040207420"),
              facebook_get_photo_ans);
    EXPECT_EQ(facebook->get_friends_urls_by_id("https://www.facebook.com/profile.php?id=100043040207420"),
              facebook_get_friends_ans);
    EXPECT_EQ(facebook->get_group_participants("https://www.facebook.com/groups/2558160454233543"),
              facebook_get_group_ans);

    EXPECT_EQ(facebook->get_friends_urls_by_id("https://www.facebook.com/profile.php?id=100043040207420ahsjdhja"),
              vector<string>());
    EXPECT_EQ(facebook->get_group_participants("https://www.facebook.com/groups/551899082309567"), vector<string>());
    EXPECT_EQ(facebook->get_group_participants("https://www.facebook.com/groups/55189908230956asdjhasjdhj7"),
              vector<string>());
...
TEST_F(TestListGenerator, test_facebook_lg) {
    vector<string> vec = {"https://www.facebook.com/profile.php?id=100026228050631",
                          "https://www.facebook.com/profile.php?id=100026228050632",
                          "https://www.facebook.com/profile.php?id=100026228050633",
                          "https://www.facebook.com/profile.php?id=100026228050634",
    ...
    vector<string> generate_data = {"https://www.facebook.com/profile.php?id=100026228050636",
                                    ...
                                    "https://www.facebook.com/profile.php?id=100026228050638",
                                    "https://www.facebook.com/profile.php?id=100026228050639",
...
TEST(CurlTests, Curltest) {
    Curl curler;
    string response = curler.request(
